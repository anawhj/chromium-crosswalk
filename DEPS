...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@a99bb33f98b1271ebabe264118bb0e5f32ec7cd7',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@8fc5740bd773261499790b416c80996423e25e14',
...
deps_os = {
  'android': {
    ...
    'src/third_party/android_tools':
      (Var("chromium_git")) + '/android_tools.git@c6fdd87edb3dce0570e5096b957d2c4baaf06d64',
